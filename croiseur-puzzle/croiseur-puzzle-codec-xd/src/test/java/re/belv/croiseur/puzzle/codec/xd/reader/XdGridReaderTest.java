...
final class XdGridReaderTest {
    ...
    void readBlocks() {
        ...
        assertEquals(Set.of(at(0, 0), at(1, 0), at(2, 0),
    ...
    void readMixed() {
        ...
        assertEquals(Map.of(at(0, 0), "A", at(3, 0), "C", at(4, 0), "D", at(5, 0), "E",
                            at(1, 1), "F", at(4, 1), "H", at(5, 1), "I", at(6, 1), "J",
                            at(2, 2), "K", at(5, 2), "M"),
                     xdGrid.filled());
        assertEquals(Set.of(at(2, 0),
                            at(3, 1),
                            at(4, 2),
                            at(5, 3), at(6, 3)),
                     xdGrid.blocks());
        assertEquals(Set.of(at(1, 0),
                            at(2, 1),
                            at(3, 2), at(6, 2), at(7, 2),
                            at(3, 3), at(4, 3), at(7, 3), at(8, 3)),
                     xdGrid.nonFilled());
        assertEquals(Stream.of(at(6, 0), at(7, 0), at(8, 0),
                               at(0, 1), at(7, 1), at(8, 1),
                               at(0, 2), at(1, 2), at(8, 2),
                               at(0, 3), at(1, 3), at(2, 3)).collect(toSet()),
                     xdGrid.spaces());
    }
}
