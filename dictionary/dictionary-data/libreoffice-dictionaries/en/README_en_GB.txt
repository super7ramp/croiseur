This dictionaryViewModel was initially based on a subset of the
...
size of the dictionaryViewModel. It is hoped that this will
...
Original version of the en_GB dictionaryViewModel:
...
2010-03-09 (nemeth AT OOo)
		   — UTF-8 encoded dictionaryViewModel:
...
2019-11-01
to
2021-11-01 — Added thousands of possessives and plurals.
		   — Improved flags: "3", "N", "O", "W".
-------

MARCO A.G.PINTO:
Since the dictionaryViewModel wasn't updated for many years, I forked it in 2013 to add new words and fixes.
...
The dictionaryViewModel icon in the Extension Manager was designed by Pedro Marques.

The sources used to verify the spelling of the words I included in the dictionaryViewModel:
...
Main difficulties developing this dictionaryViewModel:
 1) Proper names;
 2) Possessive forms;
 3) Plurals.
