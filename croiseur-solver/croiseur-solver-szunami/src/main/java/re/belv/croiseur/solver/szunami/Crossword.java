 ...
 *
 * @param contents a single string representing all the grid; '*' represents a shaded box and ' ' (represents an empty
 *     box)
 * @param width the grid width (i.e. the number of columns)
 * @param height the grid height (i.e. the number of rows)
 * @see <a href="https://docs.rs/xwords/0.3.1/xwords/crossword/struct.Crossword.html">Crate Documentation</a>
 */
public record Crossword(String contents, int width, int height) {
     ...
     *
     * @param contents a single string representing all the grid; '*' represents a shaded box and ' ' (represents an
     *     empty box)
     * @param width the grid width (i.e. the number of columns)
     * @param height the grid height (i.e. the number of rows)
