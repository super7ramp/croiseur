...
public interface Backtracker<VariableT, EliminationReasonT> {
    ...
    /**
     * Determines the variable(s) to unassign to solve the dead-end reached on given variable, accompanied by a reasons.
     *
     * @param variable unassignable variable
     * @return the variable(s) that should be unassigned and why; An empty list if none could be found
     */
