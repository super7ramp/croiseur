 ...
 * Slot definition.
 *
 * <p>Example of {@link Type#HORIZONTAL horizontal} slot:
 *
 * <pre>
 *      0 1 2 3 4 5 6
 *   0 | | | | | | | |
...
final class SlotDefinition {
     ...
     *
     * <ul>
     *   <li>the x coordinate for a vertical slot definition
     *   <li>the y coordinate for a horizontal slot definition
     * </ul>
     *
     * @return the offset
     */
     ...
     *
     * <ul>
     *   <li>2 if "this" is "ABCD" and "other" is "ECF" because "C" is the third letter for "this" slot.
     *   <li>1 if "this" is "ECF" and "other" is "ABCD" because "C" is the second letter for "this" slot.
     * </ul>
     *
     * @param other other slot definition
