...
final class GridTest {
    ...
    void newGrid_inconsistentLength() {
        ...
        assertEquals("Inconsistent number of columns: Row #1 has 2 columns but row #0 has 3",
    ...
    void slots_simple() {
        ...
        final List<Slot> expectedSlots = List.of(Slot.across(0, 0, 3, 0),
                                                 Slot.across(1, 0, 3, 1),
                                                 Slot.across(2, 0, 3, 2),
                                                 Slot.down(3, 0, 3, 0),
                                                 Slot.down(4, 0, 3, 1),
    ...
    void slots_withBlocks() {
        ...
        final List<Slot> expectedSlots = List.of(Slot.across(0, 0, 3, 1),
                                                 Slot.across(1, 0, 2, 2),
                                                 Slot.down(2, 0, 3, 0),
                                                 Slot.down(3, 1, 3, 1),
                                                 Slot.down(4, 0, 2, 2));
