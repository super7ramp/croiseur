...
public record PrefilledBox(Coordinate coordinate, char value) {
     ...
     */
    static PrefilledBox valueOf(final String text) {
        ...
        return new PrefilledBox(parsedCoordinate, parsedValue);
    }
}
