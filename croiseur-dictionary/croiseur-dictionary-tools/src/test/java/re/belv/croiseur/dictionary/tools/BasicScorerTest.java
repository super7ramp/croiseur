...
final class BasicScorerTest {
    ...
    /**
     * Example: "HELLO", "WORLD" will return 3.0 (3.0/1.0) because there are 3 ways to cross word pairs on a total of 1
     * word pair:
     *
     * <pre>
     *        |W|             |W|             |W|
    ...
    /**
     * Example: "HELLO", "CROSS", "WORLD" will return 2.00 (6.0/3.0) because there are 6 ways to cross word pairs on a
    ...
    /**
     * Example: "HELLO", "CROSS", "WORD" will return 1.33 (4.0/3.0) because there are 4 ways to cross word pairs on a
     * total of 3 word pairs:
     *
     * <ul>
     *   <li>HELLO and CROSS:
