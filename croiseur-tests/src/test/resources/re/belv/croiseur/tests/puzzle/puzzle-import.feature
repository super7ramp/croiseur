...
Feature: Import Puzzle
  ...
  Scenario: Import Puzzle - xd Format - Decoding Error
    ...
    D3. Clues. ~ CFI
    """
    Then the application presents the puzzle import error "Error while importing puzzle: re.belv.croiseur.puzzle.codec.xd.reader.XdMetadataReadException: Invalid metadata: Invalid property 'Title - Example Grid'. Property must respect the format 'Key: Value'."
