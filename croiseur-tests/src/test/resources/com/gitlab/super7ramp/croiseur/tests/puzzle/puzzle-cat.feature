...
Feature: Display Puzzle
  ...
  The application provides a way to display a puzzle of this puzzle repository.

  Scenario: Display Puzzle - Nominal Case
    ...
    When user requests to display puzzle with id 1
  ...
  Scenario: Display Puzzle - Puzzle does not exist
    When user requests to display puzzle with id 404
