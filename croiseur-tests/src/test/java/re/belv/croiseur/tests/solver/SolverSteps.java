...
public final class SolverSteps {
    ...
    @When("^user requests to solve and save the following grid" + OPTIONALLY_WITH_SOLVER
            + AND_OPTIONALLY_WITH_DICTIONARY
            + AND_OPTIONALLY_WITH_RANDOMNESS + ":$")
    public void whenSolveAndSave(
            final String solver,
    ...
    public void whenSolveAndGetClues(
            final String solver,
            final String dictionary,
            final String dictionaryProvider,
            final Long randomSeed,
    ...
    @When("^user requests to solve the following grid" + OPTIONALLY_WITH_SOLVER + AND_OPTIONALLY_WITH_DICTIONARY
            + AND_OPTIONALLY_WITH_RANDOMNESS + ":$")
