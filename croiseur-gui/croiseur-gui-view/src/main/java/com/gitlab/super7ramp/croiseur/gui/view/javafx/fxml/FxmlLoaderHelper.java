...
package com.gitlab.super7ramp.croiseur.gui.view.javafx.fxml;
...
public final class FxmlLoaderHelper {
     ...
     */
    public static void load(final Object object) {
        load(object, null);
    }
     ...
     * @throws UncheckedIOException if an error occurs during loading
     */
    public static void load(final Object object, final ResourceBundle resourceBundle) {
