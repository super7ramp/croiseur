...
import com.gitlab.super7ramp.crosswords.dictionary.hunspell.codec.util.Triplet;
...
import static com.gitlab.super7ramp.crosswords.dictionary.hunspell.codec.util.MoreCollections.triplets;
...
final class BeginMiddleEndCompounder implements Compounder {
    ...
    public Stream<String> apply(final Collection<DicEntry> dicEntries) {
        ...
        return triplets(beginnings, middles, ends)
                .stream()
