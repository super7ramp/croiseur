 ...
 *
 * <p>Results of the requests are forwarded to the {@link re.belv.croiseur.spi.presenter.puzzle.PuzzlePresenter
 * PuzzlePresenter}.
 *
 * <p>All methods expect non-{@code null} parameters and raise a {@link NullPointerException} if given a {@code null}
 * parameter.
 */
public interface PuzzlePersistenceService {
     ...
     * @param puzzleId the puzzle id
     * @see
     *     re.belv.croiseur.spi.presenter.puzzle.PuzzlePresenter#presentLoadedPuzzle(re.belv.croiseur.common.puzzle.SavedPuzzle)
     ...
     *
     * <p>A new record will be added to the puzzle repository.
     *
     ...
     *
     * <p>No record will be added to the puzzle repository: The existing record will be updated.
     *
     * @param puzzle the puzzle to save
     * @see
     *     re.belv.croiseur.spi.presenter.puzzle.PuzzlePresenter#presentSavedPuzzle(re.belv.croiseur.common.puzzle.SavedPuzzle)
    ...
    /**
     * Same effect as {@link #save(ChangedPuzzle)}, but patch parameter contains only the modifications since last save.
     *
     * <p>Method applies the given modifications then saves the result.
     *
