 ...
 */
public final class ObservableAggregateList<T> extends ObservableListBase<T> implements AggregateList<T> {
     ...
     */
    public ObservableAggregateList(final AggregateList<T> backingListArg) {
