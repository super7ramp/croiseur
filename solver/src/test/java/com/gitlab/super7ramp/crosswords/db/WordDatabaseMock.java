package test.java.com.gitlab.super7ramp.crosswords.db;

import com.gitlab.super7ramp.crosswords.solver.WordVariable;
...
final class WordDatabaseMock implements WordDatabase {
    ...
    @Override
    public int countPossibleValues(WordVariable wordVariable) {
